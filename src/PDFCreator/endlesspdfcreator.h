...
private:
    ...
    double leftMargin() const { return 10; }
    double rightMargin() const { return 25; }
    double topMargin() const { return 10 + m_additionalTopMargin; }
    double bottomMargin() const { return 10 - m_additionalTopMargin; }
public:
